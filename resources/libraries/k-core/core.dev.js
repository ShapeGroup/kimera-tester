...
const ui = (() => {
        ...
        */
        ...
        debug(`:: [🛈 Version] V2.8.32f11z kimera`);
    ...
    //--------------------------------------------------//
        ...
        const lazyloader = () =>
        {
            ...
            function lazyobserver(lazywhenviewlist,lazyobserverlist)
            {
                ...
                {
					window.document.onscroll = ()=>{ console.log("SCROLLING"); };
    ...
    //--------------------------------------------------//
        ...
        eventDone( () => {
			...
			document.querySelectorAll('.k-version')[0].innerHTML = "V2.8.32f11z"
