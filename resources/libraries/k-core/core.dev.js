...
const ui = (() => {
        ...
        */
        ...
        debug(`:: [🛈 Version] V2.8.32f11e kimera`);
        ...
        const lazyloader = () =>
        {
            ...
            function lazyobserver(lazywhenviewlist,lazyobserverlist)
            {
                ...
                if(lazyobserverlist.length>-1 || lazywhenviewlist.length>-1)
                {
                    ...
                    winbody.onwheel = ev_scrollpage => checkheight;
    ...
    //--------------------------------------------------//
        ...
        eventDone( () => {
			...
			document.querySelectorAll('.k-version')[0].innerHTML = "V2.8.32f11e"
